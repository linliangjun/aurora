...
#ifndef __AURORA_SEG_H
#define __AURORA_SEG_H
...
{
    NULL_SEG = 0,
    WRITEABLE_DATA_SEG = 0b0010, // 可写数据段
    CODE_SEG = 0b1000            // 代码段
};
...
#define SEG_DESC_NULL \
    (seg_desc_t){0, 0, NULL_SEG, 0, 0, 0, 0, 0, 0, 0, 0, 0}
