...
$(BUILD_DIR)/rootfs/user_task: rootfs/user_task.lds $(BUILD_DIR)/rootfs/user_task.o $(BUILD_DIR)/rootfs/syscall.o
	$(LD) -T $< -o $@ $(BUILD_DIR)/rootfs/user_task.o $(BUILD_DIR)/rootfs/syscall.o
